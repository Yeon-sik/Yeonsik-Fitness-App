...
export function mapLegacyExercise(contract, exercise) {
  ...
  return {
    ...
    primarySubPart: exercise.primarySubPart ?? null,
    primarySubPartNameKo: exercise.primarySubPartNameKo ?? null,
    secondarySubParts: exercise.secondarySubParts ?? [],
    secondarySubPartNamesKo: exercise.secondarySubPartNamesKo ?? [],
    equipmentNameKo: exercise.equipmentNameKo ?? null,
